...
public class ViewExpenseCategories extends ListActivity {
	...
	// used to pass the ID of the expense category to the delete dialog (bad but bundle not available)
	...
	protected Dialog onCreateDialog(int id) {
		...
		case DELETE_EXPENSE_CATEGORY_DIALOG:
			...
			builder.setMessage(string.view_expense_categories_delete_expense_category_message).setCancelable(false)
