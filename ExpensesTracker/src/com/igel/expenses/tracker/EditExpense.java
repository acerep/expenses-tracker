...
public class EditExpense extends Activity {
	...
	protected Dialog onCreateDialog(int id) {
		switch (id) {
		case DATE_DIALOG:
			return new DatePickerDialog(this, mDateSetListener, mExpenseDate.get(Calendar.YEAR), mExpenseDate
					.get(Calendar.MONTH), mExpenseDate.get(Calendar.DAY_OF_MONTH));
		}
		return null;
	}

	// the callback received when the user "sets" the date in the expense date dialog
